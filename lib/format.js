...
/* getColorPosition -- TODO Move to tests
var testTable = [
    Colors.BLACK,
    Colors.WHITE,
    Colors.RED,
];
var testIndex = Utils.getColorPosition(testTable, Colors.WHITE);
...
var Format = inherit(/** @lends Format.prototype */{
    ...
    updateTables : function (colorTable, fontTable) {
        ...
        this.backgroundColorPos = Utils.getColorPosition(colorTable, this.backgroundColor);
