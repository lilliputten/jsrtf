...
Format.prototype.updateTables = function(colorTable, fontTable){
  //TODO indexOf doesn't work on RGB objects! this never works :(
  this.fontPos = fontTable.indexOf(this.font),
  this.colorPos = colorTable.indexOf(this.color),
  this.backgroundColorPos = colorTable.indexOf(this.backgroundColor);
